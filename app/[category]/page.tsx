...
export default function CategoryPage() {
  ...
  const masterData = useMemo(() => [
    // TSHIRTS ONLY
    { id: 1, type: "tshirts", sub: "Round Neck", name: "Zen Oversize", price: "₹1,499", image: "/images/tshirts/round_neck/MV16_ICEGN_0103_S125_JKY_1.webp" },
    ...
    { id: 24, type: "tshirts", sub: "Henley", name: "Zen Oversize", price: "₹1,499", image: "/images/tshirts/henley/GENTS-BLISS-Henley-Men-Shirts-Short-Sleeve-T-shirts-for-Men-Crew-Neck-Color-Block-Men-Shirts_276d6fef-d87a-4a9e-89fb-0080f408e795.c6276153b5ccb3cf42853dca18108902.webp" },
    { id: 25, type: "tshirts", sub: "Sleeve Less", name: "Zen Oversize", price: "₹1,499", image: "/images/tshirts/sleeve_less/best-sleeveless-t-shirts-for-men-500-2-1553257616.jpg" },
    { id: 26, type: "tshirts", sub: "Drop Sholder", name: "Zen Oversize", price: "₹1,499", image: "/images/tshirts/drop_shoulder/t3137-100-slub-cotton-drop-shoulder-t-shirt-for-man-1.webp" },
    { id: 27, type: "tshirts", sub: "Puff Print", name: "Zen Oversize", price: "₹1,499", image: "/images/tshirts/puff_print/FirstRow-FRT2025Cream-M-001.jpg" },

    // SHIRTS ONLY
    { id: 3, type: "shirts", sub: "Mandarin Collar", name: "Royal Knit Polo", price: "₹2,299", image: "/images/shirts/mandarin/5015121-HQ149371-SP24130124_01-2100.webp" },
    { id: 4, type: "shirts", sub: "Formal", name: "Royal Knit Polo", price: "₹2,299", image: "/images/shirts/formals/71xl+0HbB3L._SL1500_.jpg" },
    { id: 5, type: "shirts", sub: "Denim", name: "Royal Knit Polo", price: "₹2,299", image: "/images/shirts/denim/c439ebc9c3efa828c1ec0c6e343459e9.jpg" },
    { id: 6, type: "shirts", sub: "Printed", name: "Royal Knit Polo", price: "₹2,299", image: "/images/shirts/printed/white_scenery_printed_shirts_for_men_base_4_1_2023_400x533.jpg" },
    { id: 16, type: "shirts", sub: "Linen", name: "Royal Knit Polo", price: "₹2,299", image: "/images/shirts/linen/R.jpg" },
    { id: 17, type: "shirts", sub: "Half Sleeve", name: "Royal Knit Polo", price: "₹2,299", image: "/images/shirts/half_sleeve/730c98fb-0a55-4551-a5f8-7be5fedbacf71718040229285TheRoadsterLifestyleCoPureCottonHalfSleeveShirts1.jpg" },

    // PANTS ONLY
    { id: 7, type: "pants", sub: "Cargo", name: "Formal Trouser", price: "₹3,999", image: "/images/pants/cargo/CargoPantOutfitsLBBanana2-768x998.jpg" },
    { id: 6, type: "pants", sub: "Trouser", name: "Formal Trouser", price: "₹3,999", image: "/images/pants/trouser/mx007_brown_1_large.jpg" },
